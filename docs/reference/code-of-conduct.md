...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers through the contact information listed in the repository or via direct message on GitHub. All complaints will be reviewed and investigated promptly and fairly.

## Laboratory Safety and Biosecurity

Users are responsible for conducting any protein design experiments in accordance with applicable laboratory safety protocols and biosecurity regulations. Do not use REvoDesign to create or modify biological agents for harmful purposes, and ensure that all experimental work is reviewed by qualified professionals and performed in properly equipped facilities.
...
2. **Warning** – A written warning and possible temporary ban from community interactions.
