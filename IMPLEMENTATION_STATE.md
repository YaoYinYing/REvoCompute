...
- Twelve candidate projects remain formally on the wait list until production API acceptance passes. All five Batch B families have locally passing contracts; Boltz has exact candidate acceptance, three more have provisioned assets pending SIF/live gates, and Protenix's official asset host currently cannot complete a TLS handshake through the configured proxy.
