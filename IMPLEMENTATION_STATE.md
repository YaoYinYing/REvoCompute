...
| dynamicMPNN | Code `af351ee737bdb2ca2804a308d9abc8fd7c303270`; MIT. Dedicated CPU admission family on the compatible Torch 2.2.1 stack, preventing its missing checkpoint or receipt from changing readiness for established `mpnn` tasks. Dynamic pI, surface-patch, and benchmark-qualified motif-avoidance parameters are exposed. | Provision the ProteinMPNN checkpoint, build the family SIF, and run design/artifact live acceptance before enablement. |
